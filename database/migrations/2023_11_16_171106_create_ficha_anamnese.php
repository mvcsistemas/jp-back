...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ficha_anamnese', function (Blueprint $table) {
            ...
            $table->string('data_realizacao_ultimo_backup_obs');
            ...
            $table->string('fisico_desejado_obs');
